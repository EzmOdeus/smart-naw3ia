...
import { View, StyleSheet, ScrollView, Image, TouchableOpacity, Share, Platform } from 'react-native';
        ...
        <View style={styles.contentContainer}>
          ...
          <View style={styles.contentText}>
            {newsItem.content.split('\n\n').map((paragraph, index) => (
              <Text key={index} variant="body" color="gray.800" style={styles.paragraph}>
                {paragraph}
              </Text>
            ))}
          </View>

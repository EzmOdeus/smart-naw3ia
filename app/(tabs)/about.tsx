...
import { MapPin, Phone, Mail, Globe, Instagram, Facebook, Twitter, Youtube } from 'lucide-react-native';
...
export default function AboutScreen() {
  ...
  const getSocialIcon = (platform: string) => {
    switch (platform.toLowerCase()) {
      case 'facebook':
        return <Facebook size={20} color={Colors.white} />;
      case 'twitter':
        return <Twitter size={20} color={Colors.white} />;
      case 'instagram':
        return <Instagram size={20} color={Colors.white} />;
      case 'youtube':
        return <Youtube size={20} color={Colors.white} />;
      default:
        return <Globe size={20} color={Colors.white} />;
    }
  };
      ...
      >
        ...
        <View style={styles.section}>
          ...
          {aboutInfo.goals.items.map((goal, idx) => (
            <Text key={idx} variant="body" color="gray.800" style={styles.historyText}>
              • {goal}
            </Text>
          ))}
        </View>
        ...
        <View style={styles.section}>
          ...
          {aboutInfo.values.items.map((value, index) => (
            <Card key={index} style={styles.valueCard}>
              <Text variant="subtitle" color="primary.500" style={styles.valueTitle}>
                {value.title}
              </Text>
              <Text variant="body" color="gray.800">
                {value.description}
          ...
          <View style={styles.leadershipGrid}>
            {aboutInfo.leadership.members.map((leader, index) => (
              <Card key={index} style={styles.leaderCard}>
                ...
                <Text variant="subtitle" color="primary.500" style={styles.leaderName}>
                  {leader.name}
                </Text>
        ...
        <View style={styles.section}>
          ...
          <Image source={{ uri: aboutInfo.organizationalStructure.image }} style={styles.historyImage} />
          <Text variant="body" color="gray.800" style={styles.historyText}>
        ...
        <View style={styles.section}>
          ...
          <Card style={styles.contactCard}>
            ...
            <TouchableOpacity style={styles.contactItem} onPress={handlePhonePress}>
              ...
              <Text variant="body" color="primary.500" style={styles.contactText}>
          ...
          <Text variant="subtitle" color="primary.500" style={styles.socialTitle}>
            {t('about.socialMedia')}
          </Text>

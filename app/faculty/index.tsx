...
export default function FacultyScreen() {
  ...
  const renderFacultyItem = ({ item }: { item: typeof facultyMembers[0] }) => (
    <Card
    ...
    >
      <View style={styles.facultyContent}>
        ...
        <View style={styles.facultyInfo}>
          <Text variant="subtitle" color="primary.500">{item.name}</Text>
          <Text variant="caption" color="gray.600">{item.title}</Text>
          <Text variant="caption" color="gray.600">{item.department}</Text>

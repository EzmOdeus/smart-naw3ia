...
import { Mail, Phone, BookOpen, FileText, Bookmark } from 'lucide-react-native';
      ...
      >
        <View style={styles.profileHeader}>
          ...
          <View style={styles.profileInfo}>
            <Text variant="h4" color="primary.500">{member.name}</Text>
            <Text variant="subtitle" color="gray.600">{member.title}</Text>
            <Text variant="body" color="secondary.600" style={styles.department}>
              {member.department}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.contactContainer}>
          <Button
            variant="outline"
            leftIcon={<Mail size={18} color={Colors.primary[500]} />}
        ...
        <Card style={styles.infoCard}>
          ...
          <Text variant="subtitle" color="primary.500" style={[styles.infoTitle, styles.topSpacing]}>
            {t('faculty.office')}
          </Text>
          <Text variant="body" color="gray.800">
            {member.office}
        ...
        <Card style={styles.coursesCard}>
          {member.courses.map((course, index) => (
            <View key={index} style={styles.courseItem}>
              <BookOpen size={18} color={Colors.secondary[500]} />
          ...
          {member.publications.map((publication, index) => (
            <View key={index} style={styles.publicationItem}>
              ...
              <View style={styles.publicationContent}>
                ...
                <Text variant="caption" color="gray.600" style={styles.publicationMeta}>

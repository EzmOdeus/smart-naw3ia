...
export const aboutInfo: AboutInfo = {
  dean: {
    name: 'أ.د/ نجده إبراهيم محمود ماضى',
    message:
      'تسعى كلية التربية النوعية إلى الريادة في إعداد المعلم النوعي المتميز علميًا ومهاريًا وقيميًا، والمساهمة في تطوير المجتمع من خلال برامج أكاديمية وبحثية متطورة. نرحب بجميع الطلاب ونتمنى لهم التوفيق والنجاح.',
  ...
  values: {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          'تشجيع التفكير الإبداعي والابتكار في جميع مجالات العمل الأكاديمي.',
      },
      {
        title: 'الانتماء والمسؤولية',
        description:
          'تعزيز روح الانتماء للكلية والوطن وتحمل المسؤولية المجتمعية.',
      },
      {
        title: 'العمل الجماعي',
        description: 'تعزيز التعاون والعمل بروح الفريق بين جميع منسوبي الكلية.',
      },
      {
        title: 'الشفافية والنزاهة',
        description: 'الالتزام بقيم الشفافية والنزاهة في جميع التعاملات.',
      },
    ],
  },
  leadership: {
    ...
    members: [
      {
        name: 'أ.د/نجده إبراهيم محمود ماضى',
        title: 'عميد الكلية',
        image: require('./../assets/images/WhatsApp_Image_2023-06-02_at_9.39.02_PM.jpg'),
      },
      {
        name: 'أ.د/ جيهان فاروق ابو  الخير',
  ...
  organizationalStructure: {
    ...
    image: require('./../assets/images/WhatsApp_Image_2023-12-27_at_4.58.17_PM.jpeg'),
  },
  strategicPlan: {
    title: 'الخطة الاستراتيجية',
    content:
      'تسعى الكلية من خلال خطتها الاستراتيجية إلى تطوير البرامج الأكاديمية، وتعزيز البحث العلمي، وخدمة المجتمع، وتحقيق التميز المؤسسي على المستويين المحلي والإقليمي.',
